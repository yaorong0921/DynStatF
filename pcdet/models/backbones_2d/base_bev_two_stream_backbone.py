...
class BaseBEVTwoStreamBackbone(nn.Module):
    ...
    def forward(self, data_dict):
        ...
        for i in range(len(self.blocks)):
            ...
            x = x.clone() + self.reduce_layers[i](data_dict['spatial_features_%dx' % stride])

            ## ret_dict['spatial_features_%dx_single' % stride] = x
            # data_dict['cur_spatial_features_%dx' % stride] = x
